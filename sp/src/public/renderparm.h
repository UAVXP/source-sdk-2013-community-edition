...
enum RenderParamVector_t
{
	...
	// GSTRINGMIGRATION
	VECTOR_RENDERPARM_SDK2013CE_CASCADED_FORWARD,
	VECTOR_RENDERPARM_SDK2013CE_CASCADED_STEP,
	VECTOR_RENDERPARM_SDK2013CE_CASCADED_AMBIENT_MIN,
	VECTOR_RENDERPARM_SDK2013CE_CASCADED_AMBIENT_DELTA,
